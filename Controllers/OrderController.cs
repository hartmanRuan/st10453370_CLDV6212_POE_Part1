...
namespace ABCRetailers.Controllers
{
    public class OrderController : Controller
    {
        ...
        {
            //Console.WriteLine("Order ID: " + order.ProductId);
           // Console.WriteLine("Order ID: " + order.ProductName);
            //Console.WriteLine("Order ID: " + order.CustomerId);
           // Console.WriteLine("Order ID: " + order.UserName);
           // Console.WriteLine("Order ID: " + order.Quantity);
            //Console.WriteLine("Order ID: " + order.UnitPrice);
